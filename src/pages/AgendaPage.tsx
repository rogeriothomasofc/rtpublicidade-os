...
import { CalendarDays, RefreshCw, Link2, Unlink, ChevronLeft, ChevronRight, Clock } from 'lucide-react';
...
export default function AgendaPage() {
  ...
  // Listen for OAuth popup close to refresh status
  useEffect(() => {
    const handleFocus = () => {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              {status?.connected
                ? 'Sua agenda sincronizada com o Google Calendar'
