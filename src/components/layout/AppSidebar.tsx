...
import { LayoutDashboard, Users, FolderKanban, CheckSquare, DollarSign, TrendingUp, PanelLeftClose, Zap, UsersRound, FileText, FileCheck, Settings, Lightbulb, X, Clapperboard, Bot } from 'lucide-react';
