...
import {
  Loader2, Users, Building2, Globe, Trash2,
  Sparkles, Copy, MessageCircle, ExternalLink, AlertTriangle, XCircle,
  CheckCircle, Stethoscope, Kanban, MapPin,
  Instagram, Briefcase, FileText, Lightbulb, Flame, Bell, BellOff, CalendarClock,
  Phone, Star, TrendingUp,
} from 'lucide-react';
import { toast } from 'sonner';
import {
  useCrossedLeads as _useCrossedLeads, markFirstContactInCadence,
  type CrossedLead,
...
export function LeadDetailModal({ lead, onClose }: { lead: CrossedLead; onClose: () => void }) {
